...
#include "DotEffectClass.generated.h"

/**
 * 
 */
UCLASS()
class THELONGDARKFAKE_API UDotEffectClass : public UObject, public ISetEfectInterface 
{
	GENERATED_BODY()
private:
	...
	UPROPERTY(BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	FName m_statID; // 효과를 받을 스탯
	UPROPERTY(BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	float m_EffectDuration; // 효과 지속 시간
	UPROPERTY(BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	float m_EffectInterval; // 효과 주기
	UPROPERTY(BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
